...
module.exports = {
  ...
  errorHandler: function(){
    console.log(`${chalk.black.bgRed.bold(`ლ(ಠ益ಠლ)`)}🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥${chalk.red.bold(`BEGIN ERROR`)}🔥🔥🔥🔥🔥🔥🔥${chalk.black.bgRed.bold(`‎(╯ ಥ益ಥ )╯ ┻━┻`)}`);
    for (let i = 0; i < arguments.length; i++) {
      console.log(arguments[i]);
    }
    console.log(`${chalk.black.bgRed.bold(`\･┻━┻︵╰(ಥДಥ╰)`)}🔥🔥🔥🔥🔥🔥🔥🔥🔥${chalk.red.bold(`END ERROR`)}🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥${chalk.black.bgRed.bold(`(ノ\`Д ́)ノ`)}`);
  },
  //visible log
  log: function(){
